...
public class DisplaySMSActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            originNum = extras.getString("Number");
            ...
            public void onClick(View v) {
                ...
                if (secretKeyString.length() > 0
                    ...
                    try {
                        ...
                        String decText1=null;
                        String decText2=null;
                        String decText3=null;
                        String Seckey1="90812ij895qw1239p7183529";
                        String Seckey2="908178pk546sa39pa718352a";
                        String Seckey3="097123478956123losd8354p";
                        String encdtext3=new String(result);
                        decText1=TrippleDe._decrypt(encdtext3,Seckey3).toString();
                        decText2=TrippleDe._decrypt(decText1,Seckey2).toString();
                        decText3=TrippleDe._decrypt(decText2,Seckey1).toString();
                        // set the text view for the decrypted message
                        decryptedMsg.setText(decText3);
                    } catch (Exception e) {
                        // in the case of message corrupted or invalid key
                        // decryption cannot be carried out
                        decryptedMsg.setText(e.getMessage());
                    }
                } else
